...
Usage:
    python -m densa_deck.benchmarks.analyst_gauntlet --backend mock
    python -m densa_deck.benchmarks.analyst_gauntlet --backend llama_cpp
"""
...
def default_cases() -> list[GauntletCase]:
    ...
    """
    from densa_deck.benchmarks.analyst_gauntlet_decks import all_cases
